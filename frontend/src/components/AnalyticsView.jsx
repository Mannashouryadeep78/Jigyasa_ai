...
export default function AnalyticsView({ sessions, onBack }) {
    ...
    return (
        ...
        >
            <div className="flex-shrink-0 px-4 md:px-8 pt-4 md:pt-0">
                <button
                    onClick={onBack}
                    className="mb-6 flex items-center gap-2 text-white/60 hover:text-white transition font-bold tracking-widest text-xs uppercase"
                >
