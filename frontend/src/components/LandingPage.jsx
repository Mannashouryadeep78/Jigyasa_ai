        ...
        <div className="min-h-dvh font-sans" style={{ fontFamily: "'Outfit', sans-serif" }}>
            ...
            <div className="relative min-h-dvh overflow-hidden" style={{
                ...
                <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-8 md:px-14 pt-8 sm:pt-20 pb-20 flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-0 min-h-[calc(100dvh-120px)] sm:min-h-[calc(100dvh-160px)]">
                    {/* Left: Headline — each line staggers in individually */}
                    <div className="lg:w-3/5 w-full text-center lg:text-left">
                        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-2 sm:gap-4 mb-2">
                            {/* Sparkle icon pops in first */}
                            <motion.div
                                initial={{ opacity: 0, scale: 0.3, rotate: -30 }}
                                animate={{ opacity: 1, scale: 1, rotate: 0 }}
                                transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1] }}
                                className="mt-1 sm:mt-3 shrink-0"
                            >
                                <SparkleIcon className="w-6 h-6 sm:w-10 sm:h-10 text-white" />
                            </motion.div>

                            {/* Each headline line reveals upward with stagger */}
                            <h1 className="text-[1.6rem] xs:text-[2.2rem] sm:text-[3.2rem] md:text-[4rem] lg:text-[5rem] font-bold leading-[0.95] tracking-tighter text-white overflow-hidden">
                                {[
                                    { text: 'Ace', cls: '' },
                                    { text: 'Your Next', cls: '' },
                                    { text: 'Professional', cls: 'text-white' },
                                    { text: 'Tutor Interview', cls: 'text-[#f5cca8]' },
                                ].map(({ text, cls }, i) => (
                    ...
                    {/* Right: Descriptor + CTA — fade + slide after headlines finish */}
                    <div className="lg:w-2/5 w-full flex flex-col items-center lg:items-end lg:justify-center lg:pt-48">
                        <div className="max-w-xs text-center lg:text-right">
                            <motion.p
                                ...
                                className="text-white/60 text-xs sm:text-sm font-medium leading-relaxed mb-6 sm:mb-8"
                            >
